package vn.duyhai.laptopshop.service.specification;
...
import vn.duyhai.laptopshop.domain.Product_;
...
public class ProductSpecs {
    ...
    public static Specification<Product> matchPrice(double min, double max){
        return (root, query, criteriaBuilder) 
        -> criteriaBuilder.and(criteriaBuilder.gt(root.get(Product_.PRICE), min),
    ...
    public static Specification<Product> matchMultiPrice(double min, double max){
        ...
        // y het cach lam o case 5 ben tren
    }
}
