...
import vn.duyhai.laptopshop.domain.Order;
...
import vn.duyhai.laptopshop.domain.dto.ProductCriteriaDTO;
import vn.duyhai.laptopshop.repository.CartDetailRepository;
import vn.duyhai.laptopshop.repository.CartRepository;
import vn.duyhai.laptopshop.repository.OrderDetailRepository;
import vn.duyhai.laptopshop.repository.OrderRepository;
import vn.duyhai.laptopshop.repository.ProductRepository;
import vn.duyhai.laptopshop.service.specification.ProductSpecs;
...
public class ProductService {
    ...
    public Specification<Product> buildPriceSpecification(List<String> price) {
        Specification<Product> combinedSpec = Specification.where(null); // hoac sd disconjunction
        int count = 0;
        for(String p : price){
            double min = 0;
            double max = 0;
