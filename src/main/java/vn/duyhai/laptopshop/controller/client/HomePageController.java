...
import vn.duyhai.laptopshop.service.OrderService;
...
public class HomePageController {
    ...
    public String getHomePage(Model model) {
        Pageable pageable = PageRequest.of(0, 10); // dung PageRequest of de biet la lay trang bao nhieu voi phan tu bao nhieu
